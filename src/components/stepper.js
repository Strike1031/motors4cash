                        ...
                        <Col sm={12} lg={6} className='mb-3'>
                            <Card className='border border-0 rounded rounded-0 bg-main-gray text-black-50 w-full py-4'>
                                <Card.Body >
                                    ...
                                    <Card.Text>
                                        <div className='text-black-50 mb-2'><Image src={MapIcon} width="20" className='me-2' /><strong>Branch: </strong><span>Cricklewood</span></div>
                                        <div className='text-black-50 mb-2'><Image src={DateIcon} width="20" className='me-2' /><strong>Branch: </strong><span>Cricklewood</span></div>
                                    </Card.Text>
                                </Card.Body>
                            </Card>
                        </Col>
