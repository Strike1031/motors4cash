...
export default function SubDetailPage() {
    ...
    const VehicleDamageContent = () => {
        ...
        const stepperRef_s1 = useRef(null);
        const stepperRef_s2 = useRef(null);
        const stepperRef_s3 = useRef(null);
        const stepperRef_s4 = useRef(null);
        const stepperRef_s5 = useRef(null);
        const stepperRef_s6 = useRef(null);
        const stepperRef_s7 = useRef(null);
        ...
        useEffect(() => {
            ...
            stepperRef_s1.current = new Stepper(document.querySelector('#stepper1_s1'), {
                linear: false,
                animation: true,
            });
            stepperRef_s2.current = new Stepper(document.querySelector('#stepper1_s2'), {
                linear: false,
                animation: true,
            });
            stepperRef_s3.current = new Stepper(document.querySelector('#stepper1_s3'), {
                linear: false,
                animation: true,
            });
            stepperRef_s4.current = new Stepper(document.querySelector('#stepper1_s4'), {
                linear: false,
                animation: true,
            });
            stepperRef_s5.current = new Stepper(document.querySelector('#stepper1_s5'), {
                linear: false,
                animation: true,
            });
            stepperRef_s6.current = new Stepper(document.querySelector('#stepper1_s6'), {
                linear: false,
                animation: true,
            });
            stepperRef_s7.current = new Stepper(document.querySelector('#stepper1_s7'), {
                linear: false,
                animation: true,
            });
        ...
        const updateDamage = () => {
            updateVehicleDamage(newBodyWork, newPanelDamageCount, newDamageTypes, newWindScreen, newCrackedDriverSide, newCrackedPassengerSide, 
                newCrackedRearWindow, newLarge5pCoin, newDashWarningLight, newDashMaxMiles, newServiceDue, newOilWarning, 
                newEngineManagement, newAirbagWarning, newABS, newWheels, newAlloyScuffed, newTyreTradeLimit, newMirrors, 
                newMirrorFaulty, newMirrorGlass, newMirrorCover, newInterior, newHasStains, newHasTears, newHasBurns, 
                newWrapPrivatePlate,
                newWrapTwoKeys,
                newWrapOverMOT,
                newWrapLogbook,
                ...
                <div id="stepper1" className="bs-stepper">
                    <div className="bs-stepper-header">
                        ...
                        <div className="step" data-target="#test-l-7">
                            <button className="step-trigger d-none" type="button" >
                            </button>
                        </div>
                    </div>
                            ...
                            <Row>
                                ...
                                <Col lg={6}>
                                    <div id="test-l-1" className="content">
                                        <div id="stepper1_s1" className="bs-stepper">
                                            <div className="bs-stepper-header">
                                                <div className="step" data-target="#test-l-1-1">
                                                    <button className="step-trigger">
                                                    </button>
                                                </div>
                                                <div className="step" data-target="#test-l-1-2">
                                                    <button className="step-trigger">
                                                    </button>
                                                </div>
                                            </div>
                                            <div className="bs-stepper-content">
                                                <div id="test-l-1-1" className="content">
                                                    <div>
                                                        <Row>
                                                            <Col md={8} className="mx-auto">
                                                                ...
                                                                <Row>
                                                                    <Col>
                                                                        <Button className='btn btn-secondary w-100' onClick={() => {setNewBodyWork(1);stepperRef_s1.current.next();}} active={newBodyWork == 1 ? true : false}>Yes</Button>
                                                                    </Col>
                                                                    <Col>
                                                                        <Button className='btn btn-secondary w-100' onClick={() => {setNewBodyWork(0);stepperRef.current.next();}} active={newBodyWork == 0 ? true : false}>No</Button>
                                                                    </Col>
                                                                </Row>
                                                ...
                                                <div id="test-l-1-2" className="content">
                                                    <div>
                                                        <Row>
                                                            <Col md={8} className="mx-auto">
                                                                <button
                                                                    type="button"
                                                                    className="btn w-30 text-start bg-none text-primary"
                                                                    onClick={() => { stepperRef_s1.current.previous() }}
                                                                >
                                                                    ← Back
                                                                </button>
                                                            </Col>
                                    ...
                                    <div id="test-l-2" className="content">
                                        <div id="stepper1_s2" className="bs-stepper">
                                            <div className="bs-stepper-header">
                                                <div className="step" data-target="#test-l-2-1">
                                                    <button className="step-trigger">
                                                    </button>
                                                </div>
                                                <div className="step" data-target="#test-l-2-2">
                                                    <button className="step-trigger">
                                                    </button>
                                                </div>
                                            </div>
                                            <div className="bs-stepper-content">
                                                <div id="test-l-2-1" className="content">
                                                    <Row>
                                                        <Col md={8} className="mx-auto">
                                                            <button
                                                                type="button"
                                                    ...
                                                    <div>
                                                        <Row>
                                                            <Col md={8} className="mx-auto">
                                                                ...
                                                                <Row>
                                                                    <Col>
                                                                        <Button className='btn btn-secondary w-100' onClick={() => {setNewWindScreen(1);stepperRef_s2.current.next();}} active={newWindScreen == 1 ? true : false}>Yes</Button>
                                                                    </Col>
                                                                    <Col>
                                                                        <Button className='btn btn-secondary w-100' onClick={() => {setNewWindScreen(0);stepperRef.current.next();}} active={newWindScreen == 0 ? true : false}>No</Button>
                                                                    </Col>
                                                                </Row>
                                                                <div style={{marginBottom: "20px"}}></div>
                                                            </Col>
                                                ...
                                                <div id="test-l-2-2" className="content">
                                                    <Row>
                                                        <Col md={8} className="mx-auto">
                                                            <button
                                                                type="button"
                                                                className="btn w-30 text-start bg-none text-primary"
                                                                onClick={() => { stepperRef_s2.current.previous(); }}
                                                            >
                                                                 ← Back
                                                            </button>
                                                        </Col>
                                    ...
                                    <div id="test-l-3" className="content">
                                        <div id="stepper1_s3" className="bs-stepper">
                                            <div className="bs-stepper-header">
                                                <div className="step" data-target="#test-l-3-1">
                                                    <button className="step-trigger">
                                                    </button>
                                                </div>
                                                <div className="step" data-target="#test-l-3-2">
                                                    <button className="step-trigger">
                                                    </button>
                                                </div>
                                                <div className="step" data-target="#test-l-3-3">
                                                    <button className="step-trigger">
                                                    </button>
                                                </div>
                                            </div>
                                            <div className="bs-stepper-content">
                                                <div id="test-l-3-1" className="content">
                                                    <Row>
                                                        <Col md={8} className="mx-auto">
                                                            <button
                                                                type="button"
                                                            ...
                                                            <Col md={8} className="mx-auto">
                                                                ...
                                                                <Row>
                                                                    <Col md={10} className="mx-auto" style={{ textAlign: "center" }}>
                                                                        <Button className='btn btn-secondary w-50' onClick={() => {stepperRef_s3.current.next() }}>Jump into the drivers seat</Button>
                                                                    </Col>
                                                                </Row>
                                                                <div style={{marginBottom: "20px"}}></div>
                                                            </Col>
                                                ...
                                                <div id="test-l-3-2" className="content">
                                                    <Row>
                                                        <Col md={8} className="mx-auto">
                                                            <button
                                                                type="button"
                                                                className="btn w-30 text-start bg-none text-primary"
                                                                onClick={() => { stepperRef_s3.current.previous() }}
                                                            >
                                                                ← Back
                                                            </button>
                                                        </Col>
                                                    ...
                                                    <div className="text-start">
                                                        <Row>
                                                            <Col md={8} className="mx-auto">
                                                                ...
                                                                <Row>
                                                                    <Col>
                                                                        <Button className='btn btn-secondary w-100' onClick={() => {setNewDashWarningLight(1);stepperRef_s3.current.next();}} active={newDashWarningLight == 1 ? true : false}>Yes</Button>
                                                                    </Col>
                                                                    <Col>
                                                                        <Button className='btn btn-secondary w-100' onClick={() => {setNewDashWarningLight(0);stepperRef.current.next();}} active={newDashWarningLight == 0 ? true : false}>No</Button>
                                                                    </Col>
                                                                </Row>
                                                            </Col>
                                                        </Row>
                                                ...
                                                <div id="test-l-3-3" className="content">
                                                    <Row>
                                                        <Col md={8} className="mx-auto">
                                                            <button
                                                                type="button"
                                    ...
                                    <div id="test-l-4" className="content">
                                        <div id="stepper1_s4" className="bs-stepper">
                                            <div className="bs-stepper-header">
                                                <div className="step" data-target="#test-l-4-1">
                                                    <button className="step-trigger">
                                                    </button>
                                                </div>
                                                <div className="step" data-target="#test-l-4-2">
                                                    <button className="step-trigger">
                                                    </button>
                                                </div>
                                            </div>
                                            <div className="bs-stepper-content">
                                                <div id="test-l-4-1" className="content">
                                                    <Row>
                                                        <Col md={8} className="mx-auto">
                                                            <button
                                                                type="button"
                                                    ...
                                                    <div>
                                                        <Row>
                                                            <Col md={8} className="mx-auto">
                                                                ...
                                                                <Row>
                                                                    <Col>
                                                                        <Button className='btn btn-secondary w-100' onClick={() => {setNewWheels(1); stepperRef_s4.current.next(); }} active={newWheels == 1 ? true : false}>Yes</Button>
                                                                    </Col>
                                                                    <Col>
                                                                        <Button className='btn btn-secondary w-100' onClick={() => {setNewWheels(0); stepperRef.current.next();}} active={newWheels == 0 ? true : false}>No</Button>
                                                                    </Col>
                                                                </Row>
                                                                <div style={{marginBottom: "20px"}}></div>
                                                            </Col>
                                                ...
                                                <div id="test-l-4-2" className="content">
                                                    <Row>
                                                        <Col md={8} className="mx-auto">
                                                            <button
                                                                type="button"
                                                                className="btn w-30 text-start bg-none text-primary"
                                                                onClick={() => { stepperRef_s4.current.previous() }}
                                                            >
                                                                 ← Back
                                                            </button>
                                                        </Col>
                                    ...
                                    <div id="test-l-5" className="content">
                                        <div id="stepper1_s5" className="bs-stepper">
                                            <div className="bs-stepper-header">
                                                <div className="step" data-target="#test-l-5-1">
                                                    <button className="step-trigger">
                                                    </button>
                                                </div>
                                                <div className="step" data-target="#test-l-5-2">
                                                    <button className="step-trigger">
                                                    </button>
                                                </div>
                                            </div>
                                            <div className="bs-stepper-content">
                                                <div id="test-l-5-1" className="content">
                                                    <Row>
                                                        <Col md={8} className="mx-auto">
                                                            <button
                                                                type="button"
                                                    ...
                                                    <div>
                                                        <Row>
                                                            <Col md={8} className="mx-auto">
                                                                ...
                                                                <Row>
                                                                    <Col>
                                                                        <Button className='btn btn-secondary w-100' onClick={() => {setNewMirrors(1);stepperRef_s5.current.next()}} active={newMirrors == 1 ? true : false}>Yes</Button>
                                                                    </Col>
                                                                    <Col>
                                                                        <Button className='btn btn-secondary w-100' onClick={() => {setNewMirrors(0);stepperRef.current.next();}} active={newMirrors == 0 ? true : false}>No</Button>
                                                                    </Col>
                                                                </Row>
                                                                <div style={{marginBottom: "20px"}}></div>
                                                            </Col>
                                                ...
                                                <div id="test-l-5-2" className="content">
                                                    <Row>
                                                        <Col md={8} className="mx-auto">
                                                            <button
                                                                type="button"
                                                                className="btn w-30 text-start bg-none text-primary"
                                                                onClick={() => {  stepperRef_s5.current.previous(); }}
                                                            >
                                                                 ← Back
                                                            </button>
                                                        </Col>
                                    ...
                                    <div id="test-l-6" className="content text-center">
                                        <div id="stepper1_s6" className="bs-stepper">
                                            <div className="bs-stepper-header">
                                                <div className="step" data-target="#test-l-6-1">
                                                    <button className="step-trigger">
                                                    </button>
                                                </div>
                                                <div className="step" data-target="#test-l-6-2">
                                                    <button className="step-trigger">
                                                    </button>
                                                </div>
                                            </div>
                                            <div className="bs-stepper-content">
                                                <div id="test-l-6-1" className="content">
                                                    <div>
                                                        <Row>
                                                            <Col md={8} className="mx-auto">
                                                                <button
                                                        ...
                                                        <Row>
                                                            <Col md={6} className="mx-auto">
                                                                ...
                                                                <Row>
                                                                    <Col>
                                                                        <Button className='btn btn-secondary w-100' onClick={() => {setNewInterior(1); stepperRef_s6.current.next();}} active={newInterior == 1 ? true : false}>Yes</Button>
                                                                    </Col>
                                                                    <Col>
                                                                        <Button className='btn btn-secondary w-100' onClick={() => {setNewInterior(0); stepperRef.current.next(); }} active={newInterior == 0 ? true : false}>No</Button>
                                                                    </Col>
                                                                </Row>
                                                                <div style={{marginBottom: "20px"}}></div>
                                                            </Col>
                                                ...
                                                <div id="test-l-6-2" className="content">
                                                    <Row>
                                                        <Col md={8} className="mx-auto">
                                                            <button
                                                                type="button"
                                                                className="btn w-30 text-start bg-none text-primary"
                                                                onClick={() => { stepperRef_s6.current.previous() }}
                                                            >
                                                                ← Back
                                                            </button>
                                                        </Col>
                                    ...
                                    <div id="test-l-7" className="content">
                                        <div id="stepper1_s7" className="bs-stepper">
                                            <div className="bs-stepper-header">
                                                <div className="step" data-target="#test-l-7-1">
                                                    <button className="step-trigger">
                                                    </button>
                                                </div>
                                            </div>
                                            <div className="bs-stepper-content">
                                                <div id="test-l-7-1" className="content">
                                                    <Row>
                                                        <Col md={8} className="mx-auto">
                                                            <button
                                                                type="button"
